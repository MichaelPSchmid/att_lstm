...
MODELS: List[ModelConfig] = [
    ModelConfig(
        ...
        log_dir_no_dropout="M1_Small_Baseline",
        log_dir_dropout="M1_Small_Baseline_Dropout",
    ),
    ModelConfig(
        id="m2",
        ...
        log_dir_no_dropout="M2_Small_Simple_Attention",
        log_dir_dropout="M2_Small_Simple_Attention_Dropout",
    ),
    ModelConfig(
        id="m3",
        ...
        log_dir_no_dropout="M3_Medium_Baseline",
        log_dir_dropout="M3_Medium_Baseline_Dropout",
    ),
    ModelConfig(
        id="m4",
        ...
        log_dir_no_dropout="M4_Medium_Simple_Attention",
        log_dir_dropout="M4_Medium_Simple_Attention_Dropout",
    ),
    ModelConfig(
        id="m5",
        ...
        log_dir_no_dropout="M5_Medium_Additive_Attention",
        log_dir_dropout="M5_Medium_Additive_Attention_Dropout",
    ),
    ModelConfig(
        id="m6",
        ...
        log_dir_no_dropout="M6_Medium_Scaled_DP_Attention",
        log_dir_dropout="M6_Medium_Scaled_DP_Attention_Dropout",
    ),
]
